...
dolar <- read.csv(file = "Data/dailydollar.csv")
...
dolargt <- read.csv(file = "Data/dollargt.csv")
...
intdata <- read.csv(file = "Data/interest.csv")
...
intgt <- read.csv(file = "Data/interestgt.csv")
...
unempgt <- read.csv(file = "Data/unemploymentgt.csv")
